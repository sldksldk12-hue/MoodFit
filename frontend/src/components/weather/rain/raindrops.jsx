/**
 * 파일: src/components/weather/rain/raindrops.jsx
 * 분류: 날씨 시각 효과 모듈
 *
 * 역할
 * - 비 애니메이션 내부에서 raindrops 관련 계산 또는 WebGL 처리를 담당합니다.
 *
 * 사용 기술
 * - Canvas/WebGL 보조 모듈
 *
...
Raindrops.prototype={
  ...
  update(){
    ...
    if (!this.destroyed) this.animationFrame = requestAnimationFrame(this.update.bind(this));
  }
}
